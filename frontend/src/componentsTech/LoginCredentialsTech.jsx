                ...
                <div className="bg-blue-50 p-4 rounded-md">
                    ...
                    <div className="space-y-2">
                        <p className="text-blue-700">
                            <span className="font-medium">Username:</span> adminTech
                        </p>
                        <p className="text-blue-700">
                            <span className="font-medium">Password:</span> adminTech123
                        </p>
                    </div>
                </div>
                <div className="bg-green-50 p-4 rounded-md">
                    ...
                    <div className="space-y-2">
                        <p className="text-green-700">
                            <span className="font-medium">Username:</span> userTech
                        </p>
                        <p className="text-green-700">
                            <span className="font-medium">Password:</span> userTech123
                        </p>
                    </div>
                </div>
            </div>
